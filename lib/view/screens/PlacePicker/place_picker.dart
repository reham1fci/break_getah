...
getCurrentLocation() ;
  ...
  Widget build(BuildContext context) {
      ...
      setState(() {
    ...
    } ,child:Text(getTranslated("save", context)??"") ,backgroundColor: AppColors.colorPrimary,),
        body:  loading? const Center(
          ...
          Center( //picker image on google map
                child: Image.asset("assets/images/picker.png",width: 50,color: AppColors.colorPrimary,)
              ),
                  ...
                  child: Padding(
                    ...
                    child: Card(
                      child: Container(
                          ...
                          child: ListTile(
                            leading: Image.asset("assets/images/picker.png", width: 25,color: AppColors.colorPrimary,),
